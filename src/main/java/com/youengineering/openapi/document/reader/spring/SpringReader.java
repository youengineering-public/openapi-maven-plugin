package com.youengineering.openapi.document.reader.spring;
...
public class SpringReader extends AbstractReader {
    ...
    @Override
    public void enrich(OpenAPI openAPI, Set<Class<?>> classes) {
        exceptionHandlerReader.processExceptionHandlers(classes);
        for (Class<?> controllerClass : classes) {
            enrichWithControllerClass(openAPI, controllerClass);
        }
    }

    private void enrichWithControllerClass(OpenAPI openAPI, Class<?> controllerClass) {
            ...
            for (Method method : controllerClass.getMethods()) {
                ...
                if (methodRequestMapping != null) {
                    ...
                    for (String methodPath : methodPaths) {
                        ...
                        enrichWithEndpoint(openAPI, controllerClass, method, fullPath, requestMethods);
                    }
                }
            }
        }
    ...
    private void enrichWithEndpoint(OpenAPI openAPI, Class<?> controllerClass, Method method, String fullPath, RequestMethod[] requestMethods) {
        ...
        for (RequestMethod requestMethod : requestMethods) {
            ...
            parseAndAddMethod(openAPI, controllerClass, method, httpMethodName, fullPath, new ArrayList<>());
        }
    }
